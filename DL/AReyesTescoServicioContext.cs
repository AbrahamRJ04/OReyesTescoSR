...
public partial class AreyesTescoServicioContext : DbContext
{
    ...
    public virtual DbSet<DatosPersonalesResidencia> DatosPersonalesResidencias { get; set; }

    public virtual DbSet<EmpresaResidencia> EmpresaResidencias { get; set; }

    public virtual DbSet<GiroEmpresa> GiroEmpresas { get; set; }

    public virtual DbSet<ModalidadResidencia> ModalidadResidencias { get; set; }

    public virtual DbSet<Programa> Programas { get; set; }

    public virtual DbSet<Proyecto> Proyectos { get; set; }

    public virtual DbSet<ProyectoResindencia> ProyectoResindencias { get; set; }

    public virtual DbSet<Sector> Sectors { get; set; }

    public virtual DbSet<ServicioSocial> ServicioSocials { get; set; }

    public virtual DbSet<TipoDependencium> TipoDependencia { get; set; }

    public virtual DbSet<TipoEmpresa> TipoEmpresas { get; set; }

    public virtual DbSet<TipoServicio> TipoServicios { get; set; }

    public virtual DbSet<VacantesServicioSocial> VacantesServicioSocials { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-AVT6ORL\\SQLEXPRESS ;Database=AReyesTescoServicio;Trusted_Connection=True; TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.IdAlumno).HasName("PK__Alumno__460B4740B5439425");
            ...
            entity.HasOne(d => d.IdServicioSocialNavigation).WithMany(p => p.Alumnos)
        ...
        {
            entity.HasKey(e => e.IdCarrera).HasName("PK__Carreras__884A8F1F971AFDD9");
        ...
        {
            entity.HasKey(e => e.IdCandidato).HasName("PK__DatosPer__D5598905CCD5C30B");
            ...
            entity.HasOne(d => d.IdCarreraNavigation).WithMany(p => p.DatosPersonalesResidencia)
                .HasForeignKey(d => d.IdCarrera)
        ...
        {
            entity.HasKey(e => e.IdEmpresaResidencias).HasName("PK__EmpresaR__C7E57D2C4360B2F1");
            ...
            entity.HasOne(d => d.IdGiroNavigation).WithMany(p => p.EmpresaResidencia)
                .HasForeignKey(d => d.IdGiro)
                .HasConstraintName("FK__EmpresaRe__IdGir__76969D2E");

            entity.HasOne(d => d.IdSectorNavigation).WithMany(p => p.EmpresaResidencia)
                .HasForeignKey(d => d.IdSector)
                .HasConstraintName("FK__EmpresaRe__IdSec__778AC167");

            entity.HasOne(d => d.IdTipoEmpresaNavigation).WithMany(p => p.EmpresaResidencia)
        ...
        {
            entity.HasKey(e => e.IdGiro).HasName("PK__GiroEmpr__98AAAF2CF6202B8D");
        ...
        {
            entity.HasKey(e => e.IdModalidadResidencias).HasName("PK__Modalida__B71133F73F1CDC4A");
        ...
        {
            entity.HasKey(e => e.IdPrograma).HasName("PK__Programa__AF94ECA525656088");
        ...
        {
            entity.HasKey(e => e.IdProyecto).HasName("PK__Proyecto__F4888673B9AD2F9F");
            ...
            entity.HasOne(d => d.IdCandidatoNavigation).WithMany(p => p.Proyectos)
                .HasForeignKey(d => d.IdCandidato)
                .HasConstraintName("FK__Proyecto__IdCand__00200768");

            entity.HasOne(d => d.IdEmpresaResidenciasNavigation).WithMany(p => p.Proyectos)
                .HasForeignKey(d => d.IdEmpresaResidencias)
                .HasConstraintName("FK__Proyecto__IdEmpr__01142BA1");

            entity.HasOne(d => d.IdModalidadResidenciasNavigation).WithMany(p => p.Proyectos)
        ...
        {
            entity.HasKey(e => e.IdSector).HasName("PK__Sector__D0011C18ABCD6B25");
        ...
        {
            entity.HasKey(e => e.IdServicioSocial).HasName("PK__Servicio__507A7B0E8008C652");
            ...
            entity.HasOne(d => d.IdProgramaNavigation).WithMany(p => p.ServicioSocials)
                .HasForeignKey(d => d.IdPrograma)
                .HasConstraintName("FK__ServicioS__IdPro__4222D4EF");

            entity.HasOne(d => d.IdTipoDependenciaNavigation).WithMany(p => p.ServicioSocials)
                .HasForeignKey(d => d.IdTipoDependencia)
                .HasConstraintName("FK__ServicioS__IdTip__412EB0B6");

            entity.HasOne(d => d.IdTipoServicioNavigation).WithMany(p => p.ServicioSocials)
        ...
        {
            entity.HasKey(e => e.IdTipoDependencia).HasName("PK__TipoDepe__15DD82E82DCCECCB");
        ...
        {
            entity.HasKey(e => e.IdTipoEmpresa).HasName("PK__TipoEmpr__1ECA987F5B00F48E");
        ...
        {
            entity.HasKey(e => e.IdTipoServicio).HasName("PK__TipoServ__E29B3EA7CE6AFD14");
        ...
        modelBuilder.Entity<VacantesServicioSocial>(entity =>
        {
            entity.HasKey(e => e.IdVacante).HasName("PK__Vacantes__A58A8FA882E22E78");

            entity.ToTable("VacantesServicioSocial");
            ...
            entity.Property(e => e.Telefono)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.VacanteDescripcion)
                .HasMaxLength(250)
                .IsUnicode(false);
        });
